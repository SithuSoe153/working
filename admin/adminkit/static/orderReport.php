...
<form action="orderReport.php" method="post">
				...
				<div class="card-body text-center">
					...
					<fieldset>
						...
						?>
							...
							<a class='btn btn-primary' href='orderdetail.php?oid=$OrderID'>Detail</a> |
							<a class='btn btn-primary' href='orderaccept.php?oid=$OrderID'>Accept</a>
