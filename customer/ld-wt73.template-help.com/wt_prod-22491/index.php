            ...
            <div class="swiper-slide-caption section-md">
                <div class="container">
                    <div class="row row-fix">
                        <div class="col-lg-5">
                            <h1 class="swiper-title-1" data-caption-animate="fadeScale" data-caption-delay="100"><span class="text-gray-22">Quality&nbsp;</span><br class="d-none d-lg-block"><span class="text-gray-23">Decor</span></h1>
        ...
        <div class="row row-30">
            <div class="col-sm-6 col-lg-4">
                <article class="box-icon-creative wow fadeInRight" data-wow-delay=".1s">
                    <div class="unit flex-column flex-md-row flex-lg-column flex-xl-row align-items-md-center align-items-lg-start align-items-xl-center unit-spacing-xs">
                        <div class="unit-left">
                            <div class="box-icon-creative-icon linearicons-couch"></div>
                        </div>
                        <div class="unit-body">
                            <h5 class="box-icon-creative-title"><a href="#">living room</a></h5>
                            <p class="box-icon-creative-text">Sofas, coffee tables, couches</p>
                        </div>
                    </div>
                </article>
            </div>
            <div class="col-sm-6 col-lg-4">
                <article class="box-icon-creative wow fadeInRight" data-wow-delay=".2s">
                    <div class="unit flex-column flex-md-row flex-lg-column flex-xl-row align-items-md-center align-items-lg-start align-items-xl-center unit-spacing-xs">
                        <div class="unit-left">
                            <div class="box-icon-creative-icon linearicons-bed"></div>
                        </div>
                        <div class="unit-body">
                            <h5 class="box-icon-creative-title"><a href="#">bedroom</a></h5>
                            <p class="box-icon-creative-text">Beds, nightstands, dressers</p>
                        </div>
                    </div>
                </article>
            </div>
            <div class="col-sm-6 col-lg-4">
                <article class="box-icon-creative wow fadeInRight" data-wow-delay=".3s">
                    <div class="unit flex-column flex-md-row flex-lg-column flex-xl-row align-items-md-center align-items-lg-start align-items-xl-center unit-spacing-xs">
                        <div class="unit-left">
                            <div class="box-icon-creative-icon linearicons-drawers3"></div>
                        </div>
                        <div class="unit-body">
                            <h5 class="box-icon-creative-title"><a href="#">dining room</a></h5>
                            <p class="box-icon-creative-text">Tables, chairs, cabinets</p>
                        </div>
                    </div>
                </article>
            </div>
            <div class="col-sm-6 col-lg-4">
                <article class="box-icon-creative wow fadeInRight" data-wow-delay=".4s">
                    <div class="unit flex-column flex-md-row flex-lg-column flex-xl-row align-items-md-center align-items-lg-start align-items-xl-center unit-spacing-xs">
                        <div class="unit-left">
                            <div class="box-icon-creative-icon linearicons-bathtub"></div>
                        </div>
                        <div class="unit-body">
                            <h5 class="box-icon-creative-title"><a href="#">Bathroom</a></h5>
                            <p class="box-icon-creative-text">Vanities, mirrors, lighting</p>
                        </div>
                    </div>
                </article>
            </div>
            <div class="col-sm-6 col-lg-4">
                <article class="box-icon-creative wow fadeInRight" data-wow-delay=".5s">
                    <div class="unit flex-column flex-md-row flex-lg-column flex-xl-row align-items-md-center align-items-lg-start align-items-xl-center unit-spacing-xs">
                        <div class="unit-left">
            ...
            <div class="col-sm-6 col-lg-4">
                <article class="box-icon-creative wow fadeInRight" data-wow-delay=".6s">
                    <div class="unit flex-column flex-md-row flex-lg-column flex-xl-row align-items-md-center align-items-lg-start align-items-xl-center unit-spacing-xs">
                        <div class="unit-left">
                            <div class="box-icon-creative-icon linearicons-baby2"></div>
                        </div>
                        <div class="unit-body">
                            <h5 class="box-icon-creative-title"><a href="#">kids room</a></h5>
                            <p class="box-icon-creative-text">Kids beds, trundlers, dressers</p>
                        </div>
                    </div>
                </article>
            </div>
    ...
    <div class="container">
        <div class="row row-30 align-items-center justify-content-center justify-content-xl-between">
            ...
            <div class="col-md-7 col-lg-6 col-xl-5">
                ...
                <p class="big offset-top-md-20 wow fadeInRight" data-wow-delay=".2s">At Sofa, we aim to supply
                    our customers with the first-class furniture & decor products that make their life
                    comfortable.</p>
                <div class="group-xl group-middle d-md-flex justify-content-sm-start wow fadeInRight" data-wow-delay=".3s">
                    <div>
                        <div class="group-lg group-middle"><a class="btn btn-sm btn-icon-3 btn-primary btn-zakaria" href="about-us.html"><span class="mdi mdi-arrow-right"></span></a>
                            <div class="team-navy">
