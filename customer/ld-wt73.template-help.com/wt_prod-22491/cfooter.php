            ...
            <div class="row row-40 row-md-50 justify-content-xl-between">
                <div class="col-sm-6 col-lg-4 col-xl-3 wow fadeInRight">
                    <div class="footer-classic-brand">
                        <!--Brand--><a class="brand" href="index.html"><img class="brand-logo-dark" src="images/new_new_word_removebg.png" alt="" width="105" height="44" /><img class="brand-logo-light" src="images/new_new_word_removebg.png" alt="" width="106" height="44" /></a>
                    </div>
                ...
                <div class="col-lg-4 wow fadeInRight" data-wow-delay=".2s">
                    ...
                    <form class="rd-form rd-mailform rd-form-inline rd-form-inline-2" data-form-output="form-output-global" data-form-type="subscribe" method="post" action="bat/rd-mailform.php">
                        ...
                        <div class="form-button">
                            <button class="btn btn-icon-2 btn-zakaria btn-primary" type="submit"><span class="fl-bigmug-line-paper122"></span></button>
                        </div>
                    </form>
                </div>
            </div>
